      ...
      <div className="homepage__container">
        ...
        <header className="homepage__header">
          <div className="homepage__logo">
            <svg className="homepage__logo-icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="homepage__card">
          <div className="homepage__form">
            ...
            <div className="homepage__input-group">
              ...
              <div className="homepage__input-wrapper">
                ...
                <input
                  ...
                  className={`homepage__input ${error ? 'homepage__input--error' : ''}`}
                  disabled={isLoading}
                  autoComplete="off"
              ...
              {error && (
                <div className="homepage__error" role="alert">
                  <svg className="homepage__error-icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            >
              {isLoading ? (
                <>
                  <svg className="homepage__spinner" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    <circle className="homepage__spinner-circle" cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="4" fill="none"/>
                  </svg>
                  Analyzing...
                </>
              ) : (
                <>
                  <svg className="homepage__button-icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
